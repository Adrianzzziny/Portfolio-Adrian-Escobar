...
const technologies = [
  {
    category: "Frontend",
    skills: ["React JS", "Next.js", "Angular", "TypeScript", "Vue JS", "React Native", "Tailwind CSS", "Redux", "Zustand", "Pinia"],
  },
  {
    category: "Backend",
  ...
  },
  {
    ...
    skills: ["Git", "Github", "Gitlab", "AWS", "Azure", "Google Cloud", "Figma", "Trello" ,"Postman"],
  },
  {
